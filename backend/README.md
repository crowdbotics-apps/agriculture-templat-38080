...
## Project Structure
    ...
    ├── agriculture_templat_38080  # Django project configurations
...
1. Clone this repo and `cd agriculture_templat_38080`
...
2. Clone this repo and `cd agriculture_templat_38080`
